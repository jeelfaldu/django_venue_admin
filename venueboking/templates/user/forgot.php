...
<!-- Mirrored from jituchauhan.com/wedding/wedding-new/forget-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Aug 2020 09:26:57 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
    <title>Wedding Venues | Find The Best Wedding Venues</title>
    <!-- Bootstrap -->
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('css/front_css/fontello.css')}}">
...
<body>
            ...
            <div class="row">
                <div class="col-md-3 logo">
                    <div class="navbar-brand">
                        <a href="index.html"><img src="{{asset('images/front_images/logo.png')}}" alt="Wedding Vendors" class="img-responsive"></a>
                    </div>
                </div>
                <div class="col-md-9">
                    <div class="navigation" id="navigation">
                        <ul>
                            ...
                            <li><a href="#" title="Home" class="animsition-link">Suppliers</a>
                                <ul>
                                    <li><a href="{{url('/viewvenues')}}">Venue List</a></li>
                                    <li><a href="{{url('/viewdecorations')}}">DECORATION LIST</a></li>
                                    <li><a href="{{url('/viewcateringes')}}">CATERING LIST</a></li>
                                    <li><a href="{{url('/viewpackages')}}">PACKAGE LIST</a></li>
                            ...
                            <li><a href="{{url('/addfeedback')}}" title="Home" class="animsition-link">Feed Back</a></li>
                            <li><a href="#" title="Home" class="animsition-link">Contact Us</a></li>
                            <li><a href="#" title="Home" class="animsition-link">Log Out</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5 ft-aboutus">
                    <h2>Wedding Venue</h2>
                    <p>At Wedding Venue our purpose is to help people find great online network connecting wedding suppliers and wedding couples who use those suppliers. <a href="#">Start Find Venue!</a></p>
    ...
    <script src="{% static 'js/front_js/jquery.min.js' %}"></script>
    <!-- Include all compiled plugins (below), or include individual files as needed -->
    <script src="{% static 'js/front_js/bootstrap.min.js' %}"></script>
    <!-- Flex Nav Script -->
    <script src="{% static 'js/front_js/jquery.flexnav.js'%}" type="text/javascript"></script>
    <script src="{% static 'js/front_js/navigation.js' %}"></script>
    <script src="{% static 'js/front_js/jquery.sticky.js' %}"></script>
    <script src="{% static 'js/front_js/header-sticky.js' %}"></script>
</body>
