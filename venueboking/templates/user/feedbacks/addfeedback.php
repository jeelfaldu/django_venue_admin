      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="{% url 'newFeedback' %}" name="addfeedback" id="addfeedback" novalidate="novalidate">
              {% csrf_token %}
              <!-- Text input -->
              <div class="control-group">
                <div class="controls">
                  <input type="hidden" name="user_id" id="user_id"  placeholder="User Id" class="form-control input-md" value="{{id}}">
                </div>
              </div>
              <!-- Text input -->
